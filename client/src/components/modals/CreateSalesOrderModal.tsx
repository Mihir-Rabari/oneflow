...
export function CreateSalesOrderModal({ open, onOpenChange, onSuccess }: CreateSalesOrderModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await billingApi.createSalesOrder({
        ...formData,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new sales order for a project
          </DialogDescription>
        </DialogHeader>
